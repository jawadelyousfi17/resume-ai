...
export const GUIDES: Guide[] = [
  {
    ...
    metaTitle: "AI Resume Builder — What It Can and Can't Do | resumeai",
    description:
...

  {
    ...
    metaTitle: "How to Write a Resume in 2026 — Step-by-Step Guide | resumeai",
    description:
...

  {
    ...
    metaTitle: "ATS-Friendly Resume — What Actually Matters | resumeai",
    description:
...

  {
    ...
    metaTitle: "Resume Summary Examples & How to Write One | resumeai",
    description:
...

  {
    ...
    metaTitle: "Resume Bullet Points — Action Verbs, Metrics, Examples | resumeai",
    description:
...

  {
    ...
    metaTitle: "Resume Format — Chronological, Functional or Hybrid | resumeai",
    description:
...

  {
    ...
    metaTitle: "Common Resume Mistakes and How to Fix Them | resumeai",
    description:
...

  {
    ...
    metaTitle: "How to Translate a Resume for International Jobs | resumeai",
    description:
...

  {
    ...
    metaTitle: "Career Change Resume — How to Write One | resumeai",
    description:
