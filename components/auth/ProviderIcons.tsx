// Brand marks for the OAuth buttons. Inline rather than from the icon set —
// these have to keep their own colors, and the HugeIcons wrapper paints
// everything with `currentColor`.
...
export function GoogleMark(props: Props) {
  return (
    <svg viewBox="0 0 24 24" aria-hidden="true" {...props}>
      ...
      <path
        fill="#EA4335"
        d="M12 4.75c1.77 0 3.35.61 4.6 1.8l3.44-3.44C17.95 1.19 15.24 0 12 0A12 12 0 0 0 1.27 6.61l4 3.11C6.22 6.88 8.87 4.75 12 4.75Z"
      />
    </svg>
  );
}
